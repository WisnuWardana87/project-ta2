                ...
                <div class="col-12">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="<?= site_url('PrestasiFBS/register_prestasi') ?>"><button type="button" class="btn btn-block btn-primary"><i class="fas fa-folder-plus"></i> Tambah Data</button></a>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="<?= site_url('PrestasiFBS/search_prestasi'); ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($prestasi as $val) { ?>
                                        <tr>
                                            ...
                                            <td><?= $val['tahun']; ?></td>
                                            <td class="text-center"><a href="<?php echo base_url(); ?>index.php/PrestasiFBS/detail/<?php echo $val['id_prestasi']; ?>">
                                                    <div class="btn btn-sm btn-success"><i class="fas fa-fw fa-search-plus"></i></div>
                                                </a></td>
                                            <td class="text-center"><a href="<?= site_url('PrestasiFBS/update_register_prestasi/' . md5($val['id_prestasi'])) ?>">
                                                    <div class="btn btn-sm btn-primary"><i class="fas fa-fw fa-edit"></i></div>
                                                </a></td>
                                            <td class="text-center"><a href="<?= site_url('PrestasiFBS/delete_prestasi/' . ($val['id_prestasi'])); ?>" onclick="return confirm('Anda yakin akan menghapus data ini ?');">
...
<div class="modal fade" id="exportData" tabindex="-1" aria-labelledby="exportDataLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= site_url('PrestasiFBS/export'); ?>" method="post">
