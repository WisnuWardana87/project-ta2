                ...
                <div class="col-12">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="<?= site_url('PrestasiFIP/register_user') ?>"><button type="button" class="btn btn-block btn-primary"><i class="fas fa-folder-plus"></i> Tambah Data</button></a>
                        </div>
                    </div>
                                        ...
                                        <div class="card bg-light">
                                            ...
                                            <div class="card-footer">
                                                <div class="text-right">
                                                    <a href="<?= site_url('PrestasiFIP/delete_user/' . ($val['id_user'])); ?>" onclick="return confirm('Anda yakin akan menghapus data ini ?');" class="btn btn-sm bg-danger">
                                                        <i class="fas fa-fw fa-trash"></i>
                                                    </a>
                                                    <a href="<?= site_url('PrestasiFIP/update_register_user/' . md5($val['id_user'])) ?>" class="btn btn-sm btn-primary">
